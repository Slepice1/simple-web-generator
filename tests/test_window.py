...
class TestWindowClass:
    ...
    def test_no_content_render(self):
        ...
        assert window_show_id.render() == ("+-header-+\n"
                                           "+--------+")
        window_show_id_fixed_width = Window(**{'id': 'header', 'show_name': True, 'width': 12, 'height': 3})
    ...
    def test_content_render(self):
        ...
        window_multiline_content = Window(**{'id': 'header', 'content': "test111\ntest2\ntest3"})
        assert window_multiline_content.render() == ("+-------+\n"
                                                     "|test111|\n"
                                                     "|test2  |\n"
                                                     "|test3  |\n"
                                                     "+-------+")
        window_multiline_empty = Window(**{'id': 'header', 'content': "test1\n\ntest3"})
    ...
    def test_no_content_basic_padding_render(self):
        ...
        assert window_one_padding_hor.render() == ("+-+\n"
                                                   "+-+")
        window_two_paddings_ver = Window(**{'id': 'header', 'padding': '1 0 1 0'})
        assert window_two_paddings_ver.render() == ("++\n"
                                                    "||\n"
                                                    "||\n"
                                                    "++")
        window_two_paddings_hor = Window(**{'id': 'header', 'padding': '0 1 0 1'})
        assert window_two_paddings_hor.render() == ("+--+\n"
                                                    "+--+")
        window_two_paddings_diff = Window(**{'id': 'header', 'padding': '1 1 0 0'})
