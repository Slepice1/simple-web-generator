...
class TestContentClass:
    def test_constructor(self):
        ...
        assert content_text_vars['plain_text'] == "Vojtěch \"Slepice1\" Jelínek"
        ...
        assert content_multiline_text_vars['plain_text'] == "test111\ntest2\ntest3"
        ...
        assert content_multiline_empty_vars['plain_text'] == "test1\n\xa0\ntest3"
        ...
        assert content_links_vars['plain_text'] == "example1\nexample2"
